...
export class DataStorageService {
    ...
    fetchRecipes(): Observable<Recipe[]> {
        ...
        // the user token is not added through the interceptor
        return this.http
                    .get<FirebaseRecipes>(
                    ...
                    .pipe(
                        ...
                        map((firebaseRecipes: FirebaseRecipes) => {
                            ...
                            console.log('inside pipe; mapping process starts.');
                            ...
                            console.log('inside pipe; mapping process ends.');
                        ...
                        tap((recipes: Recipe[]) => {
                            console.log('inside pipe; setting recipes.');
